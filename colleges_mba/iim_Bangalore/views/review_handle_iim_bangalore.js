...
fetch("/get_overall_rating_iim_bangalore")
    .then(response => {
        if (!response.ok) {
...
async function fetchRating6() {
    try {
        const response = await fetch("/get_placement_rating_iim_bangalore");
        if (!response.ok) {
            if (response.status === 404) {
...
async function fetchRating7() {
    try {
        const response = await fetch("/get_campus_life_rating_iim_bangalore");
        const data = await response.json();
        const rating = data.rating; 
...
async function fetchRating8() {
    try {
        const response = await fetch("/get_faculty_rating_iim_bangalore");
        const data = await response.json();
        const rating = data.rating; 
...
async function fetchRating9() {
    try {
        const response = await fetch("/get_infrastructure_rating_iim_bangalore");
        const data = await response.json();
        const rating = data.rating; 
...
async function fetchRating10() {
    try {
        const response = await fetch("/get_curriculum_rating_iim_bangalore");
        const data = await response.json();
        const rating = data.rating; 
