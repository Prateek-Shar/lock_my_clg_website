...
async function fetchRating() {
    try {
        const response = await fetch("/get_placement_rating_christ");
...
async function fetchRating2() {
    try {
        const response = await fetch("/get_campus_life_rating_christ");
        const data = await response.json();
        const rating = data.rating; 
...
async function fetchRating3() {
    try {
        const response = await fetch("/get_infrastructure_rating_christ");
        const data = await response.json();
        const rating = data.rating; 
...
async function fetchRating4() {
    try {
        const response = await fetch("/get_college_curriculum_rating_christ");
        const data = await response.json();
        const rating = data.rating; 
...
async function fetchRating5() {
    try {
        const response = await fetch("/get_faculty_rating_christ");
        const data = await response.json();
        const rating = data.rating; 
...
fetch("/get_overall_rating_christ")
